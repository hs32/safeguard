...
2. **Create the cloudflared config**
...
3. **Create DNS record in Cloudflare pointing the hostname to the tunnel**
...
4. **Install the tunnel as a system service (auto-start)**
...
[https://pihole.paradox-bd.com/admin/](https://pihole.paradox-bd.com/admin/)
